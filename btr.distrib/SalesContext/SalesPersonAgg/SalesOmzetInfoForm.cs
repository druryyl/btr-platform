...

{
...

    {
        ...
        Periode ISalesOmzetChartHost.ReportPeriode =>
...

        {
...

            {
...

                {
                    ...
                    var weeks = _isoWeekCalendar.ListWeeksIntersecting(reportPeriode);

                    var rows = _healthWeeklyDal.ListByYearWeeks(weeks);
