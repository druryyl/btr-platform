            ...
            switch (domain)
            {
                ...
                default:
                    throw new ArgumentException(
                        "Domain must be All, Piutang, Inventory, InventoryRisk, Sales, PrincipalSalesOut, Purchasing, PurchasingManagement, Customer, Salesman, Collection, FieldActivity, or Location.",
