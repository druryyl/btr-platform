...
{
    public class CollectionDayGrouperTest
    {
        ...
        {
            var buckets = CollectionDayGrouper.BuildBuckets(June2026);
        ...
        {
            var buckets = CollectionDayGrouper.BuildBuckets(Feb2024);
        ...
        {
            var label = CollectionDayGrouper.FormatDayLabel(new DateTime(2026, 6, 15));
        ...
        public void FindBucket_ReturnsMatchingDay()
        {
            ...
            var found = CollectionDayGrouper.FindBucket(buckets, new DateTime(2026, 6, 10));
        ...
        public void FindBucket_ReturnsNull_WhenDateOutsideRange()
        {
            ...
            CollectionDayGrouper.FindBucket(buckets, new DateTime(2026, 7, 1))
                .Should().BeNull();
        }
    }
}
