...
const rows = computed(() => purchasingReport.report?.Rows ?? [])
  ...
  return [
    {
      ...
      value: formatCurrency(purchasingReport.report.Summary.GrandTotalPurchase),
    },
    {
      label: 'Total Invoice',
      value: String(purchasingReport.report.Summary.TotalInvoice),
    },
  ]
})
