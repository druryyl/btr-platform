...
<template>
  <Card class="cash-flow-daily-pace-chart portal-chart-card">
    <template #title>
    ...
    <template #content>
      ...
      <template v-else>
        <div v-if="hasData || dailyPace.length > 0" class="cash-flow-daily-pace-chart__canvas portal-chart-canvas portal-chart-canvas--tall">
