...
<template>
  <Card class="collection-optimization-action-chart">
    ...
    <template #content>
      ...
      <div v-else-if="distribution.length > 0" class="collection-optimization-action-chart__canvas">
...
.collection-optimization-action-chart__canvas {
  height: 240px;
}
