...
<template>
  <Card class="collection-optimization-impact-chart">
    ...
    <template #content>
      ...
      <div v-else-if="distribution.length > 0" class="collection-optimization-impact-chart__canvas">
...
.collection-optimization-impact-chart__canvas {
  height: 240px;
}
