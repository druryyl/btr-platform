...
<template>
  <Card class="cash-flow-forecast-vs-billing-chart portal-chart-card">
    <template #title>
    ...
    <template #content>
      ...
      <template v-else>
        <div v-if="hasData" class="cash-flow-forecast-vs-billing-chart__canvas portal-chart-canvas">
