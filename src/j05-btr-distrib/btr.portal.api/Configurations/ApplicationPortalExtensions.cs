...
namespace btr.portal.api.Configurations
{
    public static class ApplicationPortalExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddScoped<PrincipalActiveCustomerComposer>();
            services.AddScoped<PrincipalCustomerCoverageComposer>();
            ...
            services.AddScoped<IEntityAnalyticsReplayDataLoader, CustomerReplayDataLoader>();
            services.AddScoped<IEntityAnalyticsReplayDataLoader, SalesmanReplayDataLoader>();
            services.AddScoped<IEntityAnalyticsReplayDataLoader, SupplierReplayDataLoader>();
            services.AddScoped<IEntityAnalyticsReplayDataLoader, ItemReplayDataLoader>();
            ...
            services.AddScoped<SupplierPrincipalReplayAggregator>();
