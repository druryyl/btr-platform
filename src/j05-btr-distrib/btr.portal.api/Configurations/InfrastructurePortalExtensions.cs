...
using btr.infrastructure.ReportingContext.DashboardCashFlowForecastAgg;
...
using btr.infrastructure.ReportingContext.DashboardFieldActivityOverviewAgg;
using btr.infrastructure.ReportingContext.DashboardInventoryAgg;
using btr.infrastructure.ReportingContext.DashboardInventoryForecastAgg;
using btr.infrastructure.ReportingContext.DashboardInventoryOptimizationAgg;
...
namespace btr.portal.api.Configurations
{
    public static class InfrastructurePortalExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddScoped<IPrincipalTargetEvidenceDal, PrincipalTargetEvidenceDal>();
            ...
            services.AddScoped<IPrincipalReturnEvidenceDal, PrincipalReturnEvidenceDal>();
            services.AddScoped<IPrincipalReturnHistoryEvidenceDal, PrincipalReturnHistoryEvidenceDal>();
            services.AddScoped<IPrincipalReturnHistoryDal, PrincipalReturnHistoryDal>();
            services.AddScoped<IPrincipalReturnSnapshotDal, PrincipalReturnSnapshotDal>();
            ...
            services.AddScoped<IFieldActivityBatchCheckInDal, FieldActivityBatchCheckInDal>();
            services.AddScoped<IFieldActivityBatchOrderDal, FieldActivityBatchOrderDal>();
            services.AddScoped<IFieldActivityBatchVisitPlanDal, FieldActivityBatchVisitPlanDal>();
            services.AddScoped<IDashboardFieldActivitySnapshotDal, DashboardFieldActivitySnapshotDal>();
