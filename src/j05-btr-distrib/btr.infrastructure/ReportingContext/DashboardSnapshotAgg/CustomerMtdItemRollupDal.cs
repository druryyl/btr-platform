...
{
    public class CustomerMtdItemRollupDal : ICustomerMtdItemRollupDal
    {
        private readonly DatabaseOptions _opt;

        public CustomerMtdItemRollupDal(IOptions<DatabaseOptions> opt)
        {
            _opt = opt.Value;
        }
...
WHERE bb.FakturDate BETWEEN @Tgl1 AND @Tgl2
  AND bb.VoidDate = '3000-01-01'";
            ...
            {
                return cn.Read<CustomerMtdItemRollupDto>(sql, dp);
            }
        }
    }
}
