...
| Item | Included |
| ---- | -------- |
| Materialized data for `/dashboard/sales`, `/dashboard/piutang`, `/dashboard/inventory` | Yes |
...
| Refresh cadence | Piutang **15 min**, Sales **30 min**, Inventory **60 min** | Three Task Scheduler jobs |
...
| Maximum staleness | One refresh interval (15 / 30 / 60 min per domain) |
...
8. Refresh cadence operational: 15 / 30 / 60 min per domain.
...
| Purchasing dashboard | Report exists; no dashboard yet |
