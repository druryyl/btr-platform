...
- **Dedicated Location snapshot domain** (`BTRPD_Location*`) with its own refresh worker — materialized KPIs, not read-time composition.
...
| Decision | Value |
| --- | --- |
| Snapshot domain | `BTRPD_Location*` |
...
| --- | --- | --- |
| SQL | `BTRPD_LocationKpi.sql` | **New** |
| SQL | `BTRPD_LocationTopWarehouseInventory.sql` | **New** |
| SQL | `BTRPD_LocationTopWarehouseAtRisk.sql` | **New** |
| SQL | `BTRPD_LocationTopWarehouseSales.sql` | **New** |
| SQL | `BTRPD_LocationTopWarehousePurchasing.sql` | **New** |
| SQL | `BTRPD_LocationTopWilayahSales.sql` | **New** |
| SQL | `BTRPD_LocationAttention.sql` | **New** |
...
### 5.2 `BTRPD_LocationTopWarehouseInventory`
...
### 5.5 `BTRPD_LocationTopWarehousePurchasing`

Same as 5.4 with `MtdPurchaseAmount`; `ReportRoute` null in V1.

### 5.6 `BTRPD_LocationTopWilayahSales`
...
1. Create seven `BTRPD_Location*.sql` table scripts (Section 5).
