...
- **Snapshot domain:** `Location` — 7 tables `BTR_PortalDashboardLocation*`, 60-minute refresh cadence
...
| Layer | Path |
| --- | --- |
| SQL | `btr.sql/Tables/ReportingContext/BTR_PortalDashboardLocation*.sql` |
